...
int main(int argc, char *argv[]){
	...
	char c;
	cout<<"Do you want movie recommendations for you? (y/n):";
	cin>>c;
	float avg_user;
	if(c == 'y' || c == 'Y'){
		float userRating[2000];
		float rat;
		cout<<"To give recommendations we need some data about you, Please rate the following 10 top rated movies on a scale of 1 to 5:\n";
		...
		//Now taking the top 30 users and calculating the predicted rating for each item
